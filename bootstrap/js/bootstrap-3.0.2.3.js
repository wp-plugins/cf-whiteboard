...
+function ($) { "use strict";
  ...
  var plugin = $.fn.button = function (option) {
    return this.each(function () {
      var $this   = $(this)
...
+function ($) { "use strict";
  ...
  var plugin = $.fn.carousel = function (option) {
    return this.each(function () {
      var $this   = $(this)
  ...
  $(window).on('load', function () {
    $('[data-ride="carousel"]').each(function () {
      var $carousel = $(this)
      plugin.apply($carousel, [$carousel.data()]);
    })
  })
...
+function ($) { "use strict";
  ...
  var plugin = $.fn.modal = function (option, _relatedTarget) {
    return this.each(function () {
      var $this   = $(this)
  ...
  $(document).on('click.bs.modal.data-api', '[data-toggle="bsmodal"]', function (e) {
    ...
    plugin.apply($target, [options, this]);
...
+function ($) { "use strict";
  ...
  Tooltip.prototype.enter = function (obj) {
    var self = obj instanceof this.constructor ?
      obj : plugin.apply($(obj.currentTarget), [this.getDelegateOptions()]).data('bs.' + this.type)
  ...
  Tooltip.prototype.toggle = function (e) {
    var self = e ? plugin.apply($(e.currentTarget), [this.getDelegateOptions()]).data('bs.' + this.type) : this
...
+function ($) { "use strict";
  ...
  var plugin = $.fn.scrollspy = function (option) {
    return this.each(function () {
      var $this   = $(this)
...
+function ($) { "use strict";
  ...
  var tabPlugin = $.fn.tab = function ( option ) {
    return this.each(function () {
      var $this = $(this)
...
+function ($) { "use strict";
  ...
  var plugin = $.fn.affix = function (option) {
    return this.each(function () {
      var $this   = $(this)
