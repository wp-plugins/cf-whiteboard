...
function cfwhiteboard_activate_example_post() {
    ...
    if (empty($post_id) || empty($post)) {
        ...
        $post = array(
            ...
            // 'post_category' => [ array(<category id>, <...>) ] //Add some categories.
            // 'post_content' => 'The body of this page is automatically generated by CF Whiteboard. You\'re welcome to edit the page title, the page permalink, or any other fields for this page.', //The full text of the post.
            'post_content' => 'This is a PRIVATE example post (only visible to logged-in wordpress users) that we generated to show you how to add a Whiteboard to your WOD posts.  Click <strong>Edit Post</strong> to see how to setup the Whiteboard using the CF Whiteboard entry box when you\'re posting a WOD. Please <strong><a href="mailto:faye@cfwhiteboard.com">email Faye</a></strong> with any questions or for a 10-minute phone demo.
