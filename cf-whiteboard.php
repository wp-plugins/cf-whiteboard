...
function cfwhiteboard_deactivate_athletes_page() {
    ...
    if( !empty($options['athletes_page_id']) ) {
        ...
        wp_delete_post( $options['athletes_page_id'] ); // send post to 'trash'
...
// Manage the private CFW example Whiteboard post on activation/deactivation
...
function cfwhiteboard_activate_example_post() {
    ...
    if (empty($post_id) || empty($post)) {
        ...
        $post = array(
            ...
            // 'post_category' => [ array(<category id>, <...>) ] //Add some categories.
            // 'post_content' => 'The body of this page is automatically generated by CF Whiteboard. You\'re welcome to edit the page title, the page permalink, or any other fields for this page.', //The full text of the post.
            'post_content' => 'This is a PRIVATE example post that we generated to show you how to add a Whiteboard to your WOD posts.  Click <strong>Edit Post</strong> to see how to setup the Whiteboard in the CF Whiteboard entry box when you\'re posting a WOD. As always, <strong><a href="mailto:affiliatesupport@cfwhiteboard.com">email us</a></strong> with any questions or for a phone demo.
...
<strong>* An athlete profile will be created for each athlete that records their results on the Whiteboard.</strong> The list of profiles is on your <strong><a href="'.get_permalink($options['athletes_page_id']).'">Athletes page</a></strong>. Don\'t forget to add the Athletes page to your menu bar so it\'s easy for your athletes to find.
', //The full text of the post.
            ...
            'post_title' => 'CF Whiteboard Example Post (private)', //The title of your post.
...
function cfw_admin_notice() {
    ...
    if (current_user_can('manage_options')) {
        ...
        if (!get_user_meta($user_id, 'cfw_installation_notice')) {
            ...
            $pointer_content .= '<a href="?&cfw_ignore=cfw_installation_notice" class="button" style="border-color:#fff; margin-left:10px;">Hide this message</a>';
            $pointer_content .= '</p>';
            $pointer_content .= '</div>';
...
function cfwhiteboard_options_page() {
    ...
    <div style="max-width:600px; text-align:left; line-height:1.4; font-size:13px; font-family:'Helvetica Neue', Helvetica, Verdana, sans-serif;">
        <h2>Welcome to <a href="http://cfwhiteboard.com">CF Whiteboard</a></h2>
        <p style="background:#444; border:none; color:#fff; padding:12px 15px; border-radius:3px; text-shadow:0 -1px 0 #000; box-shadow:inset 0 1px 13px #000;">
            We&apos;re currently in Beta, which means you can use the service for free.
            Don't hesitate to <a href="mailto:affiliatesupport@cfwhiteboard.com" style="color:#01a1ff;">Email Us</a> with any questions or feedback.
...
add_filter('rewrite_rules_array', 'cfwhiteboard_athletes_insert_rewrite_rules');
