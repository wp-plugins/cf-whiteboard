...
', //The full text of the post.
            ...
            'post_title' => 'CF Whiteboard is here!', //The title of your post.
...
function cfwhiteboard_options_page() {
    ...
    <div class="wrap">
        ...
        <div class="cfw-twb">
            <form method="post" action="#whiteboard" style="max-width:600px;">

                <div class="navbar js-scroll-here-on-iframe-reload">
                    <div class="navbar-inner" style="padding-right:0;">
                        <ul class="nav">
                            <li class="dropdown">
                                <a href="javascript://" class="dropdown-toggle brand" data-toggle="dropdown" data-target=" " style="background:url(<?php echo plugins_url('images/cfwhiteboard.png', __FILE__); ?>) no-repeat 5px 4px; text-indent:140px;">
                                    <b class="caret"></b>
                                </a>
        ...
        <li id="cfw-wod-'. $class_id .'">
            <h5>
                <div class="btn-group pull-right cfw-class-options">
                    <a href="javascript:// More Options" class="btn btn-stealth dropdown-toggle" data-toggle="dropdown" data-target=" ">
    ...
    return '
        <div class="tab-pane cfw-component-fields" id="'. $component_prefix .'-'. $cmp_id .'" data-cid="'. $cmp_id .'">
            <div class="cfw-header">
                ...
                <a class="cfw-back-to-overview" href="javascript:// Back to Classes Overview" data-toggle="tab" data-target="#cfwhiteboard-wods-meta .cfw-overview">
                    <i class="icon-home icon-white"></i><div class="cfw-text"><span class="nobr">Back to</span> Overview</div>
                </a>
            ...
            <div class="cfw-main">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="cfw-component-benchmark-'. $cmp_id .'">
...
function cfwhiteboard_wods_meta_box($object, $box) {
    ...
    <style type="text/css">
        ...
        #cfwhiteboard-wods-meta .cfw-header .cfw-back-to-overview,
        ...
        */
        ...
        #cfwhiteboard-wods-meta .cfw-header .cfw-back-to-overview .cfw-text {
            display: inline-block;
            margin: 0;
            max-width: 0px;
            padding: 0;
        ...
        #cfwhiteboard-wods-meta .cfw-header .cfw-back-to-overview:hover .cfw-text {
            margin-left: 5px;
            max-width: 75px;
        }
        #cfwhiteboard-wods-meta .cfw-header .cfw-back-to-overview i {
            float: left;
            margin: 7px 6px 0;
        }
        #cfwhiteboard-wods-meta .cfw-header .cfw-breadcrumbs {
        ...
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer {
            background: #fafafa;
            border-color: #ddd;
        ...
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-copy-wods-message {
            color: #80898f;
            font-size: 11px;
            font-weight: bold;
            line-height: 13px;
        ...
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-copy-wods-message strong {
            color: #40494f;
            line-height: 18px;
        }
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-copy-wods-message .btn-mini {
            margin: -7px 0 -5px 4px;
            text-transform: none;
        }
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .btn-group {
            margin-top: 11px;
        }
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-vertical-links {
            border-left: 1px solid #e5e5e5;
            padding: 0;
        }
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-vertical-links a {
        ...
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-vertical-links a + a {
            border: none;
        }
        #cfwhiteboard-wods-meta .cfw-overview .cfw-footer .cfw-vertical-links a:hover {
            background: #eee;
        }
            ...
            <div class="cfw-overview tab-pane active">
                ...
                <ul class="cfw-footer">
                    <li class="cfw-vertical-links pull-right">
                        ...
                        <br>
                        1. Copy Workouts Into Post <span style="font-weight:normal; text-transform:none;">(using button above post editor)</span> <!--<a href="javascript:// Copy to Clipboard" class="btn btn-mini">1-Click Copy</a>-->
                        <br>
        ...
        typeof(jQuery) == 'function' && jQuery(function($) {
            ...
            CFW.BenchmarkItemView = Backbone.View.extend({
                ...
                template: _.template('\
                    <a href="javascript:// Click to Choose" class="<%- description_match ? "cfw-description-match" : "" %>" data-toggle="tab" data-target="<%- component_selector %> .cfw-details-pane">\
                        <i class="icon-chevron-right"></i>\
                        <span class="cfw-select-benchmark btn btn-mini pull-right"><i class="icon-ok"></i> <span>Select</span></span>\
                        <% if (history.length > 0) { %>\
            ...
            CFW.BenchmarkDetailView = Backbone.View.extend({
                ...
                template: _.template('\
                    <div class="container">\
                        <% if (selected) { %>\
                            <a href="javascript://" class="cfw-select-benchmark btn btn-small pull-right active"><i class="icon-ok icon-white"></i> <span>Selected</span></a>\
                        <% } else { %>\
                            <a href="javascript://" class="cfw-select-benchmark btn btn-small pull-right"><i class="icon-ok"></i> <span>Select</span></a>\
                        <% } %>\
                        ...
                        <div class="details">\
                            ...
                            <% if (benchmark_group == "weightlifting") { %>\
                                <div class="lead repcount">\
                                    Find your\
                                    <input type="hidden" name="<%- selected ? "" : "tmp-" %>cfw-components[<%- component_id %>][repcount]" value="<%- repcount %>" class="cfw-repcount">\
                                    <div class="btn-group">\
                                ...
                                <textarea id="cfw-repscheme-<%- component_id %>" name="<%- selected ? "" : "tmp-" %>cfw-components[<%- component_id %>][repscheme]" class="input-block-level cfw-repscheme" rows="2"><%- repscheme %></textarea>\
                            <% } else { %>\
                ...
                initialize: function(options) {
                    ...
                    return this.render(options.selected, options.repcount || 1, options.repscheme || '');
                },

                render: function(selected, repcount, repscheme) {
                    this.$el.html(
                        this.template(
                ...
                activateSelect: function() {
                    ...
                    this.$('.cfw-repcount, .cfw-repscheme').each(function() {
                        var $input = $(this);
                        $input.attr('name', $input.attr('name').replace('tmp-',''));
                    });
                },
            ...
            CFW.BenchmarkListView = Backbone.View.extend({
                // template: _.template('\
                //     <table class="cfw-components-<%= wod.components && wod.components.length || 1 %>" cellspacing="0">\
                //         <thead>\
                //             <tr>\
                //                 <th class="cfw-known-as">Name</th>\
                //                 <% wod.components.each(function(component) { %>\
                //                     <th class="cfw-component" <%= wod.components.length == 1 ? \'colspan="2"\' : "" %> title="<%- component.get("description") %>"><%- component.get("label") %></th>\
                //                 <% }); %>\
                //             </tr>\
                //         </thead>\
                //     </table>\
                //     <div class="cfw-scrollable">\
                //         <table cellspacing="0" class="cfw-components-<%= wod.components && wod.components.length || 1 %>">\
                //             <tbody>\
                //             </tbody>\
                //         </table>\
                //     </div>\
            ...
            CFW.ComponentNavView = Backbone.View.extend({
                ...
                //     'click .cfw-back-to-overview': 'updateOverview'
                // },
            ...
            CFW.ComponentFieldsView = Backbone.View.extend({
                ...
                initialize: function(options) {
                    ...
                    if (options.el) this.initializeExistingElement();
                    else this.render();
                ...
                showDetail: function(event, model) {
                    ...
                    this.detailView = new CFW.BenchmarkDetailView({
                        ...
                        component_id: this.component_id,
                        selected: selected,
                        repcount: selected ? this.$('.cfw-benchmark-repcount').val() : null,
                        repscheme: selected ? this.$('.cfw-benchmark-repscheme').val() : null
                    });
                ...
                getDescription: function() {
                    if (this.hasSelectedBenchmark()) {
                        if (this.selectedBenchmark.get('benchmark_group') == 'weightlifting') {
                            ...
                            d = this.selectedBenchmark.get('label') +'\r\nFind your '+ $repcount.val() +' rep max.' + d;
                            
                            return d;
                        } else {
                            return this.selectedBenchmark.get('description');
                        }
                    } else {
...
function cfwhiteboard_mce_external_plugins( $plugins ) {
    $plugins['cfwhiteboard'] = plugins_url('cfwhiteboard-post-editor/cfw-mce-plugin-130114.js' , __FILE__);
    return $plugins;
}
